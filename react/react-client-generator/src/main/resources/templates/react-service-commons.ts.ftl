...
<T>(res: Response): Promise
    <T> {
        ...
        export async function mapVoidResponse(res: Response): Promise
        <void> {
            if (res.status !== 200) {
            throw await ${errorMapperIdentifier}(res);
            }
            ...
            export async function mapStringResponse(res: Response): Promise
            <string> {
                if (res.status !== 200) {
                throw await ${errorMapperIdentifier}(res);
                }
                ...
                export async function mapStreamingResponse(res: Response): Promise
                <DownloadStreamDTO
                <Uint8Array>> {
                    if (res.status !== 200) {
                    throw await ${errorMapperIdentifier}(res);
                    ...
                    return stream as DownloadStreamDTO
                    <Uint8Array>;
                        }
                        ...
                        <Uint8Array>();
                            ...
                            <Uint8Array>,
                                ...
                                private async readNext(): Promise
                                <void> {
