package de.devx.project.commons.client.typescript.utils;
...
public final class TypeScriptServiceMethodMapperUtils {

    private TypeScriptServiceMethodMapperUtils() {
        // No instances
    }
